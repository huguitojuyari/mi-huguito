...
|
*/
//estose paraconfigurr la direecioneshgugog en config ponemos en las comilla donde esta basio ejemploe'http://localhost:9095/proyectojuyari/index.php/home/index'
//$config['base_url'] = '';
